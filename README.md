...
Расчитаем нагрузку на терминацию SSL. На каждый L7 балансировщик будет приходить RPS = 6703.147/c / 5 = 1340.629/с
...
Question | idx_question_text | Для быстрого поиска вопроса по тексту
...
* Вопросы, на которые пользователь отвечает
* Рейтинги ответов пользователя
2. Подбор вопросов:
* Похожие на вопросы (по темам, тексту), на которые пользователь уже отвечал
* Вопросы без ответа
* Новые вопросы
3. Оценка каждого вопроса по:
* Совпадению с интересами пользователя
* Схожести на уже отвеченные пользователем вопросы
* Популярности
* Свежести

и сортировка вопросов в выдаче.
